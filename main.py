def atividade_fisica():
    ...
    if atividade_fisica == '1':
        ...
        match modo:
            case 'A':
                ...
                print(f"Você deve ingerir {pouco_ativo} para manter o funcionamento normal do seu corpo.")
            ...
            case 'B':
                ...
                print(f"Você deve ingerir {moderadamente_ativo:.2f} para manter o funcionamento normal do seu corpo.")
            ...
            case 'C':
                ...
                print(f"Você deve ingerir {muito_ativo:.2f} para manter o funcionamento normal do seu corpo.")
            ...
            case 'D':
                ...
                print(f"Você deve ingerir {extremamente_ativo:.2f} para manter o funcionamento normal do seu corpo.")
    ...
    if atividade_fisica == '2':
        ...
        print(f"Você deve ingerir {sedentario:.2f} para manter o funcionamento normal do seu corpo.")
        return sedentario
    else:
